...
// dedupPaths drops later arguments that name a file an earlier argument
// already named (see pathDeduper), preserving first-seen order and the
// caller's original (possibly relative) string — the same de-duplication
// contract as OpenBundleFiles (SPEC-0008 "Oversize and Duplicate File
// Handling": "cairn add a.log a.log ... MUST NOT upload a.log twice").
