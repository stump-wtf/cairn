...
type RunInput struct {
	...
	// They classify the actor of the run's artifact.created event and, for a
	// batch run, of its run.closed; the encoder refuses an event whose pair is
	// missing or inconsistent (SPEC-0016 EV-3).
