...
| Turn events (a PR review request, a new artifact) into work an agent picks up | Add Switchboard: [receive your first webhook](https://switchboard.stump.wtf/docs/getting-started/first-webhook#cairn), then route it with the [handoff recipe](https://switchboard.stump.wtf/docs/guides/routing-cookbook#route-cairn-handoffs) |
