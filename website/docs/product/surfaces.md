...
formula yet, but it installs from the module with
`go install github.com/stump-wtf/cairn/cmd/cairn@latest` — see
[Your first share](../guides/first-share.md). `curl` and your agent work against the
hosted service too.
